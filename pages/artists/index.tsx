...
export default function Index() {
  const artists = [
    ...
    },
    {
      ...
      description:
        "is an editorial cartoonist whose career is a digest of more than fifty years of local and national politics. Editorial cartoonist at the Knoxville Journal from 1958 until its closure in 1992, Daniel has been adding his wry brand of wit and insight to the Knoxville News Sentinel ever since. In 2011, the beloved editorial cartoonist donated his entire collection of hand-drawn, original cartoons to the UT Libraries, inspiring the 1,500-piece Charlie Daniel Editorial Cartoon Collection now held by the Betsey B. Creekmore Special Collections and University Archives.",
    },
    {
  ...
  return (
    <Layout>
      ...
      <StyledAbout>
        ...
        <h2>Summary</h2>
        <p>
          On November 23, 2016, an uncontained wilderness fire on the summit of
          Chimney Tops in the Great Smoky Mountains National Park, aided by
          winds approaching ninety miles-per-hour, jumped the park boundary and
          descended upon the tourist town of Gatlinburg, wreaking a level of
          destruction that was later identified as the deadliest wildfire in the
          eastern US since the 1940s and one of the largest natural disasters in
          Tennessee history. Fourteen people perished, more than 200 were
          injured, and thousands were forced to evacuate. Over 17,000 acres were
          burned and nearly 2,600 buildings and homes were damaged or destroyed.
          The social, cultural, economic, political, and natural impacts of this
          event are still being calculated.
        </p>
        <p>
          Recording the experiences of those who lived through the tragic events
          of that day and commemorating the heroism and compassion of the
          community was the objective of{" "}
          <a href="https://rfta.lib.utk.edu">
            Rising from the Ashes, an oral history project
          </a>{" "}
          of the University of Tennessee Libraries, with support from the city
          of Gatlinburg and partnership from the Anna Porter Public Library.
          Drawing inspiration from the interviews recorded by this project,
          illustrators Paige Braddock, Marshall Ramsey, and Danny Wilson used
          their skills as graphic artists to further document the experiences of
          those who were impacted by these events. This work has been generously
          supported by a grant from the National Endowment for the Arts,
          specifically their Our Town program, which funds projects that
          strengthen communities through artistic and creative engagement.
        </p>
        <h2 className="about-bordered-heading">Meet the Artists</h2>
