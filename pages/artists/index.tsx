...
export default function Index() {
  const artists = [
    {
      name: "Paige Braddock",
      collection: "https://digital.lib.utk.edu/assemble/collection/collections/paige_rftaart",
    ...
    {
      name: "Charlie Daniel",
      collection: "https://digital.lib.utk.edu/assemble/collection/collections/charlie_rftaart",
    ...
    },
    {
      ...
      collection: "https://digital.lib.utk.edu/assemble/collection/collections/marshall_rftaart",
    ...
    {
      name: "Danny Wilson",
      collection: "https://digital.lib.utk.edu/assemble/collection/collections/danny_rftaart",
  ...
  return (
    <Layout>
      ...
      <StyledAbout>
        ...
        <p>Recording the experiences of those who lived through the tragic events of that day and commemorating the heroism and compassion of the community was the objective of <a href="https://rfta.lib.utk.edu">Rising from the Ashes, an oral history project</a> of the University of Tennessee Libraries, with support from the city of Gatlinburg and partnership from the Anna Porter Public Library. Drawing inspiration from the interviews recorded by this project, illustrators Paige Braddock, Marshall Ramsey, and Danny Wilson used their skills as graphic artists to further document the experiences of those who were impacted by these events. This work has been generously supported by a grant from the National Endowment for the Arts, specifically their Our Town program, which funds projects that strengthen communities through artistic and creative engagement.</p>
