...
export default function Index() {
  const artists = [
    {
      name: "Paige Braddock",
      collection: "/api/iiif/collection/paige-rftaart",
    ...
    {
      name: "Charlie Daniel",
      collection: "/api/iiif/collection/charlie-rftaart",
    ...
    },
    {
      ...
      collection: "/api/iiif/collection/marshall-rftaart",
    ...
    {
      name: "Danny Wilson",
      collection: "/api/iiif/collection/danny-rftaart",
